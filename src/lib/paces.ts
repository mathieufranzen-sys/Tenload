 ...
 * mesures, elles priment sur l'estimation. Ce n'est qu'un repli :
 * `profiles.hr_max` fait foi dès que le profil est chargé, et se recalibre
 * depuis Profil › Fréquence cardiaque.
 */
export const HR_MAX = 185
