...
export interface MotCoach {
  ...
  /** La règle qui l'a produit. C'est elle qu'on ne répète pas le lendemain. */
  cle: string
...
export interface EntreeCoach {
  ...
  alertes?: string[]
  /** La règle du mot affiché hier, à ne pas redire aujourd'hui. */
  exclure?: string
